...
export const BLOG_SEEDS = [
  ...
  { title: "National Pension Scheme (NPS) Explained", category: "Retirement", summary: "Calculate how the NPS can secure your pension while giving you additional tax benefits under modern rules." },
  ...
  { title: "Millennial Financial Planning Guide", category: "Beginner Guides", summary: "Addressing unique generational challenges like rising tuition debt, expensive housing, and job hopping." },
  ...
  { title: "What is Hedonic Adaptation?", category: "Money Mindset", summary: "The psychological hamster wheel that keeps us wanting more, and how to program content contentment." },
