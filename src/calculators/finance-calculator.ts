...
export const calculator: CalculatorConfig = {
  ...
  metaTitle: 'All-in-One Finance Calculator Online: Wealth & Loan Tool',
  metaDesc: 'Free all-in-one finance calculator online. Toggle between compound investment accumulation and loan EMI amortization schedules with exportable charts.',
  h1Title: 'All-in-One Online Finance Calculator',
  primaryKeyword: 'all-in-one finance calculator online',
