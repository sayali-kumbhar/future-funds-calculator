...
export const BLOG_SEEDS = [
  ...
  { title: "The Best SIP Strategy for Long-Term Wealth Creation", category: "Mutual Funds", summary: "Unlock the full power of Systematic Investment Plans (SIPs). Learn about step-up SIPs, market timing myths, and optimal asset allocation.", slug: "best-sip-strategy-wealth" },
  { title: "Financial Freedom: The Complete Beginner's Action Guide", category: "Beginner Guides", summary: "New to personal finance? Here is a simple, actionable, jargon-free guide to building your first budget, emergency fund, and starting your investment journey.", slug: "financial-freedom-beginners-guide" },
  { title: "Common Retirement Planning Mistakes and How to Avoid Them", category: "Retirement", summary: "Are you making these silent wealth-killers? Avoid lifestyle inflation, waiting too long to start, and holding too much cash.", slug: "common-retirement-mistakes-to-avoid" },
  { title: "How to Increase Your Savings Rate Fast Without Painful Sacrifices", category: "Savings", summary: "Practical, painless lifestyle changes to optimize your budget, cancel unnecessary subscriptions, and increase your monthly savings rate.", slug: "how-to-increase-savings-rate-fast" },
  { title: "Burned Out? Why Coast FIRE is the Ultimate Sanity-Saving Strategy", category: "Money Mindset", summary: "If you are dreaming of quitting your 9-to-5 but aren't ready to fully retire, Coast FIRE is the ultimate sanity saver. Learn how to let compounding do the heavy lifting while you take a breath.", slug: "burned-out-coast-fire-strategy" },
  { title: "The Latte Factor vs. The Big Wins: Where Real Wealth is Created", category: "Savings", summary: "Tired of being shamed for buying a 150-rupee coffee or a $5 latte? Let's talk about why obsessing over tiny expenses is ruining your mental health, and what actually moves the needle instead.", slug: "latte-factor-versus-big-wins" },
  { title: "Navigating Money Anxiety in an Increasingly Expensive World", category: "Money Mindset", summary: "When house prices are sky-high, groceries cost a fortune, and everyone on social media seems to be a tech-millionaire, how do you keep your sanity? A guide to opting out of the comparative rat race.", slug: "money-anxiety-expensive-world" },
  { title: "Money Fights in Relationships: How to Reach Financial Compromise", category: "Personal Finance", summary: "Money is the number one cause of relationship stress. Here is a practical, judgment-free guide to merging your finances without losing your mind, your freedom, or your partner.", slug: "money-fights-relationships-compromise" },
