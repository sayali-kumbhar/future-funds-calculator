...
export const calculator: CalculatorConfig = {
  ...
  category: 'loans_debt',
  metaTitle: 'Finance Calculator Home Loan: EMI, Interest & Taxes [2026]',
  metaDesc: 'Free finance calculator home loan tool. Estimate monthly mortgage payments, total interest, property taxes, and insurance with instant interactive charts.',
  h1Title: 'Finance Calculator Home Loan & Mortgage Payment Tool',
  primaryKeyword: 'finance calculator home loan',
